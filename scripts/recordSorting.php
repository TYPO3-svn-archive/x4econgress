<?php
	...
	require_once($_SERVER['DOCUMENT_ROOT'].'/typo3conf/ext/x4econgress/pi2/class.tx_x4econgress_pi2.php');
	
	class congress_ajax extends tx_x4econgress_pi2 {
		
		function main(){
			$this->cObj = $GLOBALS["TSFE"]->cObj;
			
			
			//$GLOBALS['TSFE']->tmpl->setup['plugin.']['tx_x4econgress_pi2.']['pidList'] = 29544;
			$GLOBALS['TSFE']->tmpl->setup['plugin.']['tx_x4econgress_pi2.']['orderByList'] = 'uid';
			...
			$res = parent::main('',$GLOBALS['TSFE']->tmpl->setup['plugin.']['tx_x4econgress_pi2.']);
	...
	initTYPO3();
	$output = t3lib_div::makeInstance('congress_ajax');
	$output->main();
